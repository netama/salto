    ...
    describe('full', () => {
      it('should generate the right elements on fetch', async () => {
        ...
        expect(elements.map(e => e.elemID.getFullName()).sort()).toEqual([
          'celigo.business_hours_schedule',
          'celigo.business_hours_schedule.instance.Some_schedule@s',
          'celigo.business_hours_schedule__intervals',
          'celigo.business_hours_schedule_holiday',
          'celigo.business_hours_schedule_holiday.instance.Some_schedule__New_holiday1@suus',
          'celigo.group',
          'celigo.group.instance.group_1@s',
          'celigo.group.instance.group_2@s',
          'celigo.made_up_type_a',
          'celigo.made_up_type_a.instance.made_up_1@s',
          'celigo.made_up_type_a.instance.made_up_2@s',
          'celigo.made_up_type_a.instance.made_up_3@s',
          'celigo.made_up_type_b',
          'celigo.made_up_type_b.instance.made_up_1@s',
        ])
        expect(
          elements
        ...
        const madeUp2Values = elements
          .filter(isInstanceElement)
          .find(e => e.elemID.getFullName() === 'celigo.made_up_type_a.instance.made_up_2@s')?.value
        expect(madeUp2Values?.parent_id?.elemID?.fullName).toEqual('celigo.made_up_type_a.instance.made_up_1@s')
        expect(madeUp2Values?.other_b?.elemID?.fullName).toEqual('celigo.made_up_type_b.instance.made_up_1@s')
        const madeUp3Values = elements
          .filter(isInstanceElement)
          .find(e => e.elemID.getFullName() === 'celigo.made_up_type_a.instance.made_up_3@s')?.value
        expect(madeUp3Values?.parent_id?.elemID?.fullName).toEqual('celigo.made_up_type_b.instance.made_up_1@s')
      })
    })
  })
  describe('deploy', () => {
