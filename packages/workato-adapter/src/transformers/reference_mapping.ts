...
export const fieldNameToTypeMappingDefs: FieldReferenceDefinition[] = [
  {
    src: { field: 'code', parentTypes: ['recipes'] },
    serializationStrategy: 'fullValue',
  },
  {
    src: { field: 'api_client_id', parentTypes: ['api_access_profiles'] },
    serializationStrategy: 'id',
    target: { type: 'api_clients' },
  },
  {
    src: { field: 'api_collection_ids', parentTypes: ['api_access_profiles'] },
    serializationStrategy: 'id',
    target: { type: 'api_collections' },
  },
  {
    src: { field: 'api_collection_id', parentTypes: ['api_endpoints'] },
    serializationStrategy: 'id',
    target: { type: 'api_collections' },
  },
  {
    src: { field: 'flow_id', parentTypes: ['api_endpoints'] },
    serializationStrategy: 'id',
    target: { type: 'recipes' },
  },
  {
    src: { field: 'parent_id', parentTypes: ['folders'] },
    serializationStrategy: 'id',
    target: { type: 'folders' },
  },
  {
    src: { field: 'account_id', parentTypes: [] },
    serializationStrategy: 'id',
