...
import { WORKATO, DEFAULT_MAX_CONCURRENT_API_REQUESTS, DEFAULT_PAGE_SIZE } from '../constants'
import { Credentials } from '../types'

const { getWithOffsetPagination, DEFAULT_RETRY_OPTS } = clientUtils

export default class WorkatoClient extends clientUtils.AdapterHTTPClient<Credentials> {
  constructor(
