...
// const TRIGGER_ORDER_ENTRY_TYPE_NAME = 'trigger_order_entry' // TODON replaced by triger_order__order (confirm!)
...
const filterCreator: FilterCreator = ({
  ...
  deploy: createReorderFilterCreator({
    ...
    deployFunc, // TODON custom
    activeFieldName: 'active',
  })({ client, config, paginator, fetchQuery, elementsSource, brandIdToClient }).deploy,
})
