...
import { CUSTOM_OBJECT_FIELD_OPTIONS_TYPE_NAME, TICKET_FIELD_CUSTOM_FIELD_OPTION } from '../../../../constants'
import { ClientOptions } from '../../../requests'

const { groupWithFirstParent, groupByType } = deploymentUtils.grouping
...
export const CHANGE_GROUP_CONFIG: definitions.deploy.DeployApiDefinitions<ActionName, ClientOptions>['instances'] = {
  default: {
