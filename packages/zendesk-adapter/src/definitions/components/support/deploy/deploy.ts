...
*/
import { ActionName, getChangeData } from '@salto-io/adapter-api'
...
import { createStandardItemDeployConfigs, createStandardModifyOnlyDeployConfigs } from '../../shared/deploy/utils'
...
// TODON split into files by "component" - but a file per type is probably too much
export const SUPPORT_DEPLOY_CONFIG: definitions.deploy.DeployApiDefinitions<ActionName, ClientOptions> = {
  instances: {
    default: {
      requestsByAction: {
        default: {
