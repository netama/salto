...
import { DeployApiDefinitions } from '../../definitions/system'
...
export const getChangeGroupIdsFuncWithConfig = (
  config: DeployApiDefinitions['instances'], // TODON improve type
  changeIdProviders: ChangeIdFunction[] = [],
