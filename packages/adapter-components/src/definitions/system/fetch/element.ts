...
type StandaloneFieldDefinition = {
  ...
  // TODON generalize, and decide if belongs under standalone definition or under type definition
...
export type FetchTopLevelElementDefinition<TVal extends Values = Values> = {
  ...
  // the type should have at most one (TODON exactly one?) instance, and it will use the settings instance name.
