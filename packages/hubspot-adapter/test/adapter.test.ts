    ...
    describe('full', () => {
      it('should generate the right elements on fetch', async () => {
        ...
        expect(elements.map(e => e.elemID.getFullName()).sort()).toEqual([
          'hubspot.business_hours_schedule',
          'hubspot.business_hours_schedule.instance.Some_schedule@s',
          'hubspot.business_hours_schedule__intervals',
          'hubspot.business_hours_schedule_holiday',
          'hubspot.business_hours_schedule_holiday.instance.Some_schedule__New_holiday1@suus',
          'hubspot.group',
          'hubspot.group.instance.group_1@s',
          'hubspot.group.instance.group_2@s',
          'hubspot.made_up_type_a',
          'hubspot.made_up_type_a.instance.made_up_1@s',
          'hubspot.made_up_type_a.instance.made_up_2@s',
          'hubspot.made_up_type_a.instance.made_up_3@s',
          'hubspot.made_up_type_b',
          'hubspot.made_up_type_b.instance.made_up_1@s',
        ])
        expect(
          elements
        ...
        const madeUp2Values = elements
          .filter(isInstanceElement)
          .find(e => e.elemID.getFullName() === 'hubspot.made_up_type_a.instance.made_up_2@s')?.value
        ...
        const madeUp3Values = elements
          .filter(isInstanceElement)
          .find(e => e.elemID.getFullName() === 'hubspot.made_up_type_a.instance.made_up_3@s')?.value
