    ...
    describe('full', () => {
      it('should generate the right elements on fetch', async () => {
        ...
        expect(elements.map(e => e.elemID.getFullName()).sort()).toEqual([
          'auth0.business_hours_schedule',
          'auth0.business_hours_schedule.instance.Some_schedule@s',
          'auth0.business_hours_schedule__intervals',
          'auth0.business_hours_schedule_holiday',
          'auth0.business_hours_schedule_holiday.instance.Some_schedule__New_holiday1@suus',
          'auth0.group',
          'auth0.group.instance.group_1@s',
          'auth0.group.instance.group_2@s',
          'auth0.made_up_type_a',
          'auth0.made_up_type_a.instance.made_up_1@s',
          'auth0.made_up_type_a.instance.made_up_2@s',
          'auth0.made_up_type_a.instance.made_up_3@s',
          'auth0.made_up_type_b',
