...
export const fieldNameToTypeMappingDefs: FieldReferenceDefinition[] = [
  ...
  // zuora.CustomObjectDefinition.instance.CO1.schema.relationships.0.object
  // to objects (custom or standard)
  // and from
  // zuora.CustomObjectDefinition.instance.CO1.schema.relationships.0.fields.rel_account__c
