...
interface ClientConstructor<Credentials> {
  ...
  ): clientUtils.AdapterHTTPClient<Credentials, clientUtils.ClientRateLimitConfig>
}

export class Client<Credentials> extends clientUtils.AdapterHTTPClient<
...
export const createClient = <
  Credentials,
  P extends clientUtils.ClientOpts<Credentials, clientUtils.ClientRateLimitConfig>
    = clientUtils.ClientOpts<Credentials, clientUtils.ClientRateLimitConfig>,
>({
    adapterName,
    clientOpts,
    createConnection,
