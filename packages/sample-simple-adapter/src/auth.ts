...
const SUBDOMAIN_MESSAGE = 'subdomain (https://<your subdomain>.domain.com)'
const DOMAIN_MESSAGE = 'domain (optional) - only fill in if your account is not under domain.com (https://<subdomain>.<your domain>)'
