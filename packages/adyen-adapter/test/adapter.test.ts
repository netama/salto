    ...
    describe('full', () => {
      it('should generate the right elements on fetch', async () => {
        ...
        expect(elements.map(e => e.elemID.getFullName()).sort()).toEqual([
          'adyen.business_hours_schedule',
          'adyen.business_hours_schedule.instance.Some_schedule@s',
          'adyen.business_hours_schedule__intervals',
          'adyen.business_hours_schedule_holiday',
          'adyen.business_hours_schedule_holiday.instance.Some_schedule__New_holiday1@suus',
          'adyen.group',
          'adyen.group.instance.group_1@s',
          'adyen.group.instance.group_2@s',
          'adyen.made_up_type_a',
          'adyen.made_up_type_a.instance.made_up_1@s',
          'adyen.made_up_type_a.instance.made_up_2@s',
          'adyen.made_up_type_a.instance.made_up_3@s',
          'adyen.made_up_type_b',
          'adyen.made_up_type_b.instance.made_up_1@s',
        ])
        expect(
          elements
        ...
        const madeUp2Values = elements
          .filter(isInstanceElement)
          .find(e => e.elemID.getFullName() === 'adyen.made_up_type_a.instance.made_up_2@s')?.value
        expect(madeUp2Values?.parent_id?.elemID?.fullName).toEqual('adyen.made_up_type_a.instance.made_up_1@s')
        expect(madeUp2Values?.other_b?.elemID?.fullName).toEqual('adyen.made_up_type_b.instance.made_up_1@s')
        const madeUp3Values = elements
          .filter(isInstanceElement)
          .find(e => e.elemID.getFullName() === 'adyen.made_up_type_a.instance.made_up_3@s')?.value
        expect(madeUp3Values?.parent_id?.elemID?.fullName).toEqual('adyen.made_up_type_b.instance.made_up_1@s')
      })
    })
  })
  describe('deploy', () => {
