 ...
 */
import { createSaltoElementErrorFromError, Element, isSaltoElementError, isSaltoError } from '@salto-io/adapter-api'
import {
...
> => ({
  ...
  defaultDeploy: filters.defaultDeployFilterCreator({
